package nl.tudelft.jpacman.board; import nl.tudelft.jpacman.Api; public class Board {
	 ...
	 */
	protected final boolean invariant() {Api.hit("/src/main/java/nl/tudelft/jpacman/board/Board.java", "invariant"); for (Square[] row : board) {
	 ...
	 */
	public int getWidth() {Api.hit("/src/main/java/nl/tudelft/jpacman/board/Board.java", "getWidth"); return board.length;}
	 ...
	 */
	public int getHeight() {Api.hit("/src/main/java/nl/tudelft/jpacman/board/Board.java", "getHeight"); return board[0].length;}
	 ...
	 */
	public Square squareAt(int x, int y) {Api.hit("/src/main/java/nl/tudelft/jpacman/board/Board.java", "squareAt"); assert withinBorders(x, y); Square result = board[x][y];
	 ...
	 */
	public boolean withinBorders(int x, int y) {Api.hit("/src/main/java/nl/tudelft/jpacman/board/Board.java", "withinBorders"); return x >= 0 && x < getWidth() && y >= 0 && y < getHeight();}
}
